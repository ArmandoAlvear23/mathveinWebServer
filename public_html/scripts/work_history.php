...
if ($input){
    ...
    if (json_last_error() == JSON_ERROR_NONE){
        ...
        if (isset($json[0]["user_id"])){
            ...
            if($stmt=$mysqli->prepare("SELECT description, intensity, start_time, end_time, start_time_am_pm, end_time_am_pm, timestamp FROM work WHERE user_id = ? ORDER BY timestamp DESC LIMIT 20")){
